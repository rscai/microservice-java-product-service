...
include::{snippets}/product/getVariants/path-parameters.adoc[]

=== Request

include::{snippets}/product/getVariants/http-request.adoc[]

=== Response

include::{snippets}/product/getVariants/http-response.adoc[]
...
include::{snippets}/product/updateVariants/path-parameters.adoc[]

=== Request

include::{snippets}/product/updateVariants/http-request.adoc[]

=== Response

include::{snippets}/product/updateVariants/http-response.adoc[]
